    ...
    if (password === confirmPassword) {
       createUserWithEmailAndPassword(auth, email, password)
        .then((userCredential) => {
          ...
          // clear field after complite axicute
          setEmail("");
          setConfirmPassword("");
          setPassword("");
    ...
    <div className="hero min-h-screen bg-base-200">
      <div className="hero-content flex-col lg:flex-row-reverse">
        <div className="text-center lg:text-left">
          ...
          <p className="py-6">
            Register to enjoy personalized shopping experiences, track your
            orders, and manage your wishlist.
          </p>
        </div>
        <div className="card shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
          <form onSubmit={handleOnSubmit} className="form_main">
            <p className="heading">Register Now</p>
            ...
            <button
              type="submit"
              className="font-bold btn btn-outline btn-wide hover:bg-green z-50"
            >
              Register
            </button>
          </form>
